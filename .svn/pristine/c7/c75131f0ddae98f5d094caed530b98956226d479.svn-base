...
<div id="allinone_thumbnailsBanner_cool" style="display:none;">
                            ...
                            $x = 0;
							 while ($x < 3) { 
								$x++;
							?>
                                <li data-bottom-thumb="images/procedures/thumbnails/<?=$x?>.jpg" data-text-id="#allinone_thumbnailsBanner_photoText1"><img src="images/procedures/lips/lip_and_chin<?=$x?>.jpg" alt="" /></li>
                            <? } ?>
