...
<p>
	<ol>
        ...
        <li>
        Ablative Chemical Peel (>30% tri-chloro acetic acid TCA)- A more aggressive peel than glycolics or fruit acid peels administered by an aesthetician- this one should be administered by a physician. Chemical resurfacing allows new skin to grow, eliminating the flaws in the damaged layer (to include pre-cancerous lesions!). Dark spots and fine lines are blasted away. Down-time is about 5-7 days on average, and results are amazing. This is a favorite in our office!
        </li><br>
        ...
        <li>
        Fraxel , or fractional resurfacing- A relatively new laser technique that improves the skin in tiny spots, so down-time is lessened. The down-time is a few days, and results are variable. Best results approximate those achieved with a TCA peel. Treatment may need to be repeated to achieve best results.
        </li>
