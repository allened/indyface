    ...
    <ul class="allinone_thumbnailsBanner_list">
        ...
        $x = 0;
         while ($x < 8) { 
            $x++;
        ?>
        <li data-bottom-thumb="images/procedures/thumbnails/<?=$x?>.jpg" 
        	data-text-id="#allinone_thumbnailsBanner_photoText1">
        <img src="images/procedures/blepharoplasty/blepharoplasty<?=$x?>.jpg" alt="" />
        </li>
   		<? } ?>
    </ul>
</div>
